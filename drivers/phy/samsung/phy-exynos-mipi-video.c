...
static const struct mipi_phy_device_desc exynos7870_mipi_phy = {
	...
	.phys = {
		{
			/* EXYNOS_MIPI_PHY_ID_CSIS0 */
			.coupled_phy_id = EXYNOS_MIPI_PHY_ID_NONE, // figure it out
			.enable_val = EXYNOS4_PHY_ENABLE,
			.enable_reg = EXYNOS7870_MIPI_PHY_CONTROL(0),
			.enable_map = EXYNOS_MIPI_REGMAP_PMU,
			.resetn_val = BIT(0),
			.resetn_reg = 0,
			.resetn_map = EXYNOS_MIPI_REGMAP_CAM0,
			...
			.coupled_phy_id = EXYNOS_MIPI_PHY_ID_NONE, // figure it out
			.enable_val = EXYNOS4_PHY_ENABLE,
			.enable_reg = EXYNOS7870_MIPI_PHY_CONTROL(1),
			.enable_map = EXYNOS_MIPI_REGMAP_PMU,
			.resetn_val = BIT(0),
			.resetn_reg = 0,
			.resetn_map = EXYNOS_MIPI_REGMAP_CAM0,
			...
			.coupled_phy_id = EXYNOS_MIPI_PHY_ID_NONE, // figure it out
			.enable_val = EXYNOS4_PHY_ENABLE,
			.enable_reg = EXYNOS7870_MIPI_PHY_CONTROL(5),
			.enable_map = EXYNOS_MIPI_REGMAP_PMU,
			.resetn_val = BIT(0),
			.resetn_reg = 0,
			.resetn_map = EXYNOS_MIPI_REGMAP_CAM0,
