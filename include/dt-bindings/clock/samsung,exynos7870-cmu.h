...
#define CLK_DOUT_MIF_CMU_CPUCL0_SWITCH			129
#define CLK_DOUT_MIF_CMU_CPUCL1_SWITCH			130
#define CLK_GOUT_MIF_CMU_CPUCL0_SWITCH			131
#define CLK_GOUT_MIF_CMU_CPUCL1_SWITCH			132
#define MIF_NR_CLK					133

/* CMU_CPUCL0 */
#define CLK_FOUT_CPUCL0_PLL				1
#define CLK_MOUT_CPUCL0_PLL				2
#define CLK_GOUT_CPUCL0_MUX_PLL				3
#define CLK_MOUT_CPUCL0_SWITCH_USER			4
#define CLK_GOUT_CPUCL0_MUX_SWITCH_USER			5
#define CLK_MOUT_CPUCL0					6
#define CLK_GOUT_CPUCL0_MUX				7
#define CLK_DOUT_CPUCL0_1				8
#define CLK_DOUT_CPUCL0_2				9
#define CPUCL0_NR_CLK					10

/* CMU_CPUCL1 */
#define CLK_FOUT_CPUCL1_PLL				1
#define CLK_MOUT_CPUCL1_PLL				2
#define CLK_GOUT_CPUCL1_MUX_PLL				3
#define CLK_MOUT_CPUCL1_SWITCH_USER			4
#define CLK_GOUT_CPUCL1_MUX_SWITCH_USER			5
#define CLK_MOUT_CPUCL1					6
#define CLK_GOUT_CPUCL1_MUX				7
#define CLK_DOUT_CPUCL1_1				8
#define CLK_DOUT_CPUCL1_2				9
#define CPUCL1_NR_CLK					10
